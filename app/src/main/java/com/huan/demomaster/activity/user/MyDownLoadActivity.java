...
public class MyDownLoadActivity extends BaseActivity implements 
	...
	public void init() {
		...
		adapter = new MySimpleListAdapter(MyDownLoadActivity.this, mList);
   ...
   /* public void getNetData(){
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		Intent intent = new Intent(MyDownLoadActivity.this, NewsDetailActivity.class);
